  ...
  return (
    <div className='flex flex-col md:flex-row w-full py-[5vh] md:py-[10vh] px-[5vw] bg-white'>
        ...
        <div className="h-full w-full md:w-1/2 flex flex-col justify-center">
            ...
            <p className='mt-[2vh]'>Po parafialnych spotkaniach synodalnych, współorganizowaliśmy m.in.: wykłady, spotkania integracyjne, cykl spotkań "U św. Andrzeja czytamy Pismo święte", wspieramy także działania parafialnego Caritasu.</p>
