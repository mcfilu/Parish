  ...
  return (
    <div className='flex flex-col md:flex-row w-full py-[5vh] md:py-[10vh] px-[5vw] bg-white'>
        ...
        <div className="h-full w-full md:w-1/2 flex flex-col justify-center">
            ...
            <p className='mt-[5vh]'>Ministranci - służą Bogu i ludziom, to młodzi ludzie którzy za cel obrali sobie być najbliżej ołtarza. Służą do Mszy św. i nabożeństw w kościele, lektorzy czytają Słowo Boże, pomagają w przygotowaniu rożnych dekoracji i uroczystości kościelnych.</p>
            <p className='mt-[2vh]'>Pogłębiają swoją formację poprzez cotygodniowe spotkania w sobotę o godz. 11.00 na plebanii. Tworzą wspólnotę braterstwa poprzez wspólne zabawy i wycieczki - kręgle, strzelnica, obozy wędrowne.</p>
