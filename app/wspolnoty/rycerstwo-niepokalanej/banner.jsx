...
const Banner = () => {
  return (
    <div className='flex flex-col justify-between w-full px-[5vw]  bg-dark text-white items-center py-[5vh]'>
         ...
         <p className='text-white text-[1.7vh] mt-[5vh]'>Rycerstwo Niepokalnej spotyka się na wspólnej Eucharystii  i modlitwie przed wystawionym Najświętszym Sakramentem, w każdą I sobotę miesiąca o godz. 9.00 </p>
