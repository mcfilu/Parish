...
const Banner = () => {
  return (
    <div className='flex flex-col justify-between w-full px-[5vw]  bg-dark text-white items-center py-[5vh]'>
        ...
        <p className='w-full '>Do rodziców należy obowiązek pobudzania i wychowania dzieci do wiary. Do
...
go kochania Chrystusa, a także uformowanie chrześcijańskiego sumienia.</p>
        <p className='w-full  mt-[3vh] md:mt-0'>Zdarza się, że mało wierzący i tylko przygodnie praktykujący rodzice zwracają
się do księdza o chrzest swych dzieci.</p>
        <p className='w-full  mt-[3vh] md:mt-0'>Kościół nie może spełnić życzenia tych rodziców, jeśli nie zagwarantują oni, że
...
owoce.</p>
        <p className='w-full  mt-[3vh] md:mt-0'>Jeśli udzielone gwarancje – np. wybór rodziców chrzestnych, którzy poważnie
...
od nich a konieczne do udzielenia chrztu warunki.</p>
        <p className='w-full  mt-[3vh] md:mt-0'>Jeżeli jednak również i takie rozwiązanie nie byłoby możliwe, dziecko powinno
przejść katechumenat w okresie szkolnym.</p>
        <p className='w-full  mt-[3vh] md:mt-0'>Chrzestny ( może być tylko jeden chrzestny!) reprezentuje odpowiedzialność i
...
świadkami Chrystusa, żyjącymi wiarą na co dzień.</p>
        <p className='w-full  mt-[3vh] md:mt-0'>Do przyjęcia zadania chrzestnego może być więc dopuszczony ten, kto przyjął
