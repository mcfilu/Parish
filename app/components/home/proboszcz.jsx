...
const Proboszcz = () => {
  return (
    <div className='w-full  flex flex-row bg-white pt-[5vh]'>
        ...
        <div className='flex w-[35%] relative ml-[10%] '>
