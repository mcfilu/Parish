  ...
  return (
    <div className='w-full h-[60vh] flex relative'>
        ...
        <div className='z-10 w-full h-full py-[8vh] px-[8vw] flex flex-col justify-center items-center text-white'>
            ...
            <div className='mt-[5vh] flex flex-row justify-center text-white font-header2 text-[3.5vh] gap-10'>
                <Link href="/sakramenty/chrzest">
                <div className='flex h-[20vh] py-[2vh] w-[12vw] hover:bg-white hover:bg-opacity-10 flex-col justify-center items-center mx-[1vw]'>
