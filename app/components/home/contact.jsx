...
const Contact = () => {
  return (
    <div className='w-full bg-white md:h-[80vh] flex flex-col py-[10vh px-[8vw text-black relative flex flex-col md:flex-row'>
        

        <div className=' flex flex-col h-[50vh] md:h-full w-full md:w-[80vw]'>
        ...
        <div className=' p-6 z-10 bg-white text-black py-[5vh] md:py-0 h-[50vh] md:h-full w-full md:w-[20vh] flex flex-col'>
            ...
            <div className='flex flex-row md:flex-col h-full items-center md:items-start md:justify-center w-[20vw]'>
