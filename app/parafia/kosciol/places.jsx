  ...
  return (
    <div className='w-full flex flex-col px-[5vw] my-[5vh] bg-white'>
        ...
        <div className='flex flex-row w-full h-[50vh] my-[5vh]'>
            ...
            <div className='w-1/2 h-full relative'>
                <Image fill objectFit='cover' className='pl-[5vw]' alt="zdjecie ilustrujace miejsce w kosciele" src="/boczna.jpeg"/>
            </div>
        </div>
        <div className='flex flex-row w-full h-[50vh] my-[5vh]'>
            <div className='w-1/2 h-full relative'>
        ...
        <div className='flex flex-row w-full h-[50vh] my-[5vh]'>
            ...
            <div className='w-1/2 h-full relative'>
                <Image fill objectFit='cover' className='pl-[5vw]' alt="zdjecie ilustrujace miejsce w kosciele" src="/piwnica.jpeg"/>
            </div>
        </div>
        <div className='flex flex-row w-full h-[50vh] my-[5vh]'>
            <div className='w-1/2 h-full relative'>
        ...
        <div className='flex flex-row w-full h-[50vh] my-[5vh]'>
            ...
            <div className='w-1/2 h-full relative'>
                <Image fill objectFit='cover' className='pl-[5vw]' alt="zdjecie ilustrujace miejsce w kosciele" src="/zakrystia.jpeg"/>
            </div>
        </div>
        <div className='flex flex-row w-full h-[50vh] my-[5vh]'>
            <div className='w-1/2 h-full relative'>
