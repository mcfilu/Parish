...
const Detailed = () => {
  return (
    <div className='w-full py-[5vh] md:py-[10vh] px-[5vw] flex flex-row md:flex-col bg-white'>
        <div className='h-full w-full md:w-full pr-[5vw] items-center flex flex-col'>
            <h2 className='text-[4.5vh] font-header2'>Kościół z zewnątrz</h2>
        </div>
        <div className='h-full w-full md:w-full flex flex-col items-center justify-center text-black text-[1.7vh]'>
            <p>Kościół św. Karola Boromeusza został zaprojektowany przez włoskiego architekta
Henryka Marconiego. Świątynia jest orientowana (prezbiterium zwrócone na wschód),
wzniesiona na planie krzyża łacińskiego w stylu neorenesansowym. Jest wzorowana na
wczesnochrześcijańskich bazylikach rzymskich: św. Pawła za Murami, Santa Maria Maggiore
czy bazylice św. Wawrzyńca we Florencji oraz wzorcowym paryskim kościele Notre Dame
de Lorette, który powstał według zaleceń dotyczących sztuki sakralnej zawartych w dziele
...
płaskorzeźbami wykonanymi przez Pawła Malińskiego, kolejno przedstawiają św. Karola
Boromeusza głoszącego kazanie ludowi oraz rozdającego jałmużnę.</p>
<p className='mt-[3vh]'>Ściany świątyni zawierają liczne ozdoby architektoniczne takie jak pilastry, putta, czy
...
w następującym porządku: św. Jacek (Edmunda Szczurkiewicza), św. Czesław, św. Szymon
z  Lipnicy, św. Władysław z Gielniowa, św. Jan Kapistran, św. Wincenty Kadłubek, św. Jan
z  Dukli, św. Barbara, św. Roch i św. Florian (Teofila Godeckiego). Od umieszczenia
