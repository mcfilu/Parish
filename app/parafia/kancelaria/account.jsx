...
const Account = () => {
  return (
    <div className='w-full h-[30vh] bg-dark flex flex-row justify-between items-center text-white px-[5vw] my-[5vh]'>
        <h2 className='text-[5.5vh] font-header2 w-[40%]'>Dane Bankowe</h2>
        <div className='w-[40%] '>
